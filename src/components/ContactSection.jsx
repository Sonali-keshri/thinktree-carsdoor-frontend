...
export default function ContactSection() {
    ...
    return (
        ...
        <section className="relative overflow-hidden bg-black py-10" id="contact">
                ...
                <motion.div
                    ...
                    <form className="mt-12" onSubmit={handleSubmit}>
                        ...
                        <button
                            ...
                            className=" md:mt-6 inline-flex h-[58px] items-center justify-center bg-[#6d6d6d] px-10 font-ptsans text-[18px] text-white transition-all duration-300 hover:bg-brand-600 hover:shadow-[0_0_25px_rgba(255,0,0,.35)] disabled:cursor-not-allowed disabled:opacity-60">
                            {status === "loading" ? "Sending..." : "Get a Consultation"}
                        </button>

                        {status === "success" && (
                            <p className="mt-4 font-ptsans text-sm text-green-500">
                                Thanks! We&apos;ve received your enquiry and will reach out soon.
                            </p>
                        )}
                        {status === "error" && (
                            <p className="mt-4 font-ptsans text-sm text-red-500">
                                {errorMsg}
                            </p>
                        )}
